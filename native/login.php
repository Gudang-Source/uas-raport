                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="post">
                                        <div class="h5"> Informasi Umum </div>
                                        ...
                                        <br>
                                        <div class="h5"> Informasi Akun </div>
                                        <div class="form-group">
                                            <label> Nickname </label>
                                            <input type="text" name="akun[][nickname]" class="form-control" placeholder="Yasui Store">
                                        </div>
                                        <div class="form-group">
                                            <label> ID (Server) </label>
                                            <input type="text" name="akun[][id_server]" class="form-control" placeholder="12345678 (9999)">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                for ($i = 1; $i <= 3; $i++){
                                                ?>
                                                <input type="checkbox" name="akun[][fl]" class="checkbox-inline" value="<?= $i ?> "> #Yasui-<?= $i ?> &nbsp; &nbsp;
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
