...
<head>    <meta charset="utf-8">
    ...
    <title> Pengelolaan Nilai Sekolah </title>    
...
<link href="<?= base_url(); ?>/assets/main.cba69814a806ecc7945a.css" rel="stylesheet">
</head>
...
<div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
    <div class="app-header header-shadow">
        <div class="app-header__logo">
            ...
            <img src="<?= base_url(); ?>/assets/images/logo.png" style="max-height: 50px">
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu-xl rm-pointers dropdown-menu dropdown-menu-right">
                            <div class="dropdown-menu-header mb-0">
                                <div class="dropdown-menu-header-inner bg-deep-blue">
                                    <div class="menu-header-image opacity-1" style="background-image: url('<?= base_url(); ?>/assets/images/dropdown-header/city3.jpg');"></div>
                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="<?= base_url(); ?>/assets/images/logo.png" alt="">
                                                ...
                                                <div class="menu-header-content text-left">
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left">
                                                                <div class="widget-heading"> <?= session()->get("nama") ?>
                                                                </div>
                                                                <div class="widget-subheading opacity-8"> Description
                                                                </div>
                                                            </div>
                                                            <div class="widget-content-right mr-2">
                                                                <button class="btn-pill btn-shadow btn-shine btn btn-focus" onclick="window.location.href='<?= base_url()?>/logout'">Logout
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <ul class="vertical-nav-menu">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="<?= base_url() ?>/admin/guru/keahlian">
                                        <i class="metismenu-icon">
                                        </i> Lihat Keahlian
                                    </a>
                                </li>
                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            ...
                            <div> <?= $title["head"]; ?>
                                <div class="page-title-subheading"> <?= $title["desc"]; ?>
                                </div>
                            </div>
                        </div>
                        <?php
                        ...
                        ?>
                                <div class="page-title-actions">
                                    <button type="button" data-toggle="tooltip" title="Example Tooltip" data-placement="bottom" class="btn-shadow mr-3 btn btn-dark" id="btnTool" delete-mode="no">
                                    ...
                                    <div class="d-inline-block dropdown">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <ul class="nav flex-column">
                                                <li class="nav-item <?= (isset($add_button) && $add_button == false) ? 'd-none' : '' ?>">
                                                    <a class="nav-link" onclick="tambah()">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" onclick="hapus()">
...
<script type="text/javascript" src="<?= base_url(); ?>/assets/scripts/main.cba69814a806ecc7945a.js"></script>
</body>
</html>
